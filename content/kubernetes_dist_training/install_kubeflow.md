...
Re-run the following until it returns a valid hostname.  This may take 5-10 minutes.
```
...
AWS credentials are required to save a model in S3. These credentials are stored in EKS cluster as Kubernetes secrets.
